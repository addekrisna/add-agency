export default function Footer(){
    return(
        <>
        <section className="bg-base-200 pb-6">
            <div className="bg-base-200 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
                        ...
                        <span className="ml-2 text-xl font-bold tracking-wide text-indigo-600 uppercase">ADD Agency</span>
                    </a>
                    ...
                    <p className="text-base font-bold tracking-wide text-indigo-600">Contacts</p>
                    <div className="flex">
                    ...
                    <div>
                    <span className="text-base font-bold tracking-wide text-indigo-600">Social</span>
                ...
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                    ...
                    © Copyright 2024 ADD Agency. All rights reserved.
                    </p>
